  ...
  return (
    <div className={styles.container}>
      ...
      <header className={styles.header}>
        {isLoading ? <div>Loading....</div> : !!activeUser?.uid ? (
          <>
        ...
        {home ? (
          <>
            <img
              src={activeUser?.photoURL || "/images/profile.jpg"}
              className={utilStyles.borderCircle}
              height={144}
              width={144}
              alt={name}
            />
            <h1 className={utilStyles.heading2Xl}>{activeUser?.displayName || 'An0nymous'}</h1>
          </>
        ) : (
          <>
            <Link href="/">
            ...
            <h2 className={utilStyles.headingLg}>
              <Link href="/">
                <a className={utilStyles.colorInherit}>{activeUser?.displayName || 'An0nymous'}</a>
              </Link>
            </h2>
          </>
        )}
